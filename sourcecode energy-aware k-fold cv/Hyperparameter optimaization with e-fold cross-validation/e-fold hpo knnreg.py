...
for iteration in range(1, 26):
    ...
    best_model_efold = KNeighborsRegressor(n_neighbors=best_params_efold['n_neighbors'],
    ...
    best_model_kfold = KNeighborsRegressor(n_neighbors=best_params_kfold['n_neighbors'],
